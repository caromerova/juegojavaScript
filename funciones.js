document.addEventListener("DOMContentLoaded", function () {
  ...
  let imagenes = [
    {
      nombre: "bartflanders",
      url: "imagenes/bartyflanders.jpg",
    },
    {
      nombre: "homero",
      url: "imagenes/homero.jpg",
    },
    {
      nombre: "homeroahorcando",
      url: "imagenes/homeroahorcando.jpg",
    },
    {
      nombre: "lisaymilhouse",
      url: "imagenes/lisaymilhouse.jpg",
    },
    {
      nombre: "milhouse",
      url: "imagenes/milhouse.jpg",
    },
    {
      nombre: "paseo",
      url: "imagenes/paseo.jpg",
    },
    {
        nombre: "bartflanders",
        url: "imagenes/bartyflanders.jpg",
  ...
  let AgregarImagenes = () => {
    for (var x = 0; x < imagenes.length; x++) {
      ...
      img.setAttribute("src", "imagenes/oculta.jpg");
  ...
  function mostrarImagen() 
  {
    ...
    //getAttribute: me trae un atributo de una etiqueta
   ...
   // alert(nombreImg[imgID]+""+numeroImg[imgID]);
    ...
    //comparar las imagenes despues que de click 3 veces

    if(nombreImg.length==2)
    {
            setTimeout(compararImagenes,500);
    }
    //setTimeou establece un temporizador en milisegundos para ejecutar una funcion callback al finalizar dicho temporizador
  ...
  //crear la funcion para comparar las imagens selecionadas
  function compararImagenes()
   {
    //guardar las imagenes actuales
    ...
    if(opcionUno=== opcionDos)
    {
        if (numeroImg[0] !== numeroImg[1])
         {
            imagenesActuales[numeroImg[0]].setAttribute('src','imagenes/ok.jpg');
            imagenesActuales[numeroImg[1]].setAttribute('src','imagenes/ok.jpg');
        ...
        else
        {
            ...
            imagenesActuales[numeroImg[0]].setAttribute("src","imagenes/oculta.jpg");
            imagenesActuales[numeroImg[1]].setAttribute("src","imagenes/oculta.jpg");
        }
